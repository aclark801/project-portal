export const sponsored = [
  ...
  },
  {
    ...
    description: 'dedicated to advancing open source projects that align with the strategic objectives of the EUs IPCEI-CIS',
    repositoryURL: 'https://neonephos.org',
    documentationURL: '',
    img: 'neonephos_logo.svg',
  },
  {
    isEnable: true,
    tag: 'Infrastructure',
    name: 'Agentic AI Foundation',
    description: 'A neutral, open foundation to ensure critical capability evolves transparently, collaboratively, and in ways that advance the adoption of leading open source AI projects',
    repositoryURL: 'https://aaif.io',
    documentationURL: '',
    img: 'AAIF_Primary_Logo_Black.svg',
  },
  {
    isEnable: true,
    tag: 'Infrastructure',
